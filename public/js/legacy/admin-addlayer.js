	...
	switch(labelType)
	{
		...
		case "checkbox" :
			if (labelValue)
			{
				...
				html = '<input type="checkbox" name="labelContent[]" class="null" disabled> <input type="text" name="windowLabelValue[]" value="" size="30" style="height:18px;" class="line"> <button type="button" class="pointer" onclick="labelAdd(\'checkbox\')"><img src="/admin/skin/default/images/design/icon_design_plus.gif" height="18px" align="middle"></button>';
