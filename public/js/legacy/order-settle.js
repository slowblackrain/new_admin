...
document.write( "<script type=\"text/javascript\" src=\"//pay.kcp.co.kr/plugin/payplus_web.jsp\" charset=\"EUC-KR\" ></script>" );
/*결제사 외부 스크립트 호출 (절대 수정하지 마시오)*/
		...
		'success': function(data) {
			...
			$("input[name='payment']:checked").each(function(){
				...
				if( gl_cashreceiptuse > 0 || gl_taxuse >0 ){
					...
					if( $(this).val() == "card" ||  $(this).val() == "cellphone" || $(this).val() == "kakaopay"  || $(this).val() == "kakaopay" ||  $(this).val() == "kcp_npay_point" ||  $(this).val() == "kcp_npay_card"  ||  $(this).val() == "kcp_kakaopay" ||  $(this).val() == "kcp_payco" ||  $(this).val() == "kcp_sampay" ||  $(this).val() == "kcp_ssgpay" ){ 
