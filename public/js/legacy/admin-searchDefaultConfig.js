...
var search_date_form3			= new Array("deli_catalog");
...
}else if($.inArray(default_search_pageid,search_date_form3) >= 0){
	obj_regist_date_s	= $("input[name='sdate']");
	obj_regist_date_e	= $("input[name='edate']")
}
...
document.write('<form name="search_default_frm" method="post" action="../order/set_default_search_form" target="actionFrame">');
