...
<div class="row">
    <div class="col-12">
        ...
        <!-- Update Form -->
        <form action="{{ route('seller.goods.batch_modify.update') }}" method="POST">
            @csrf
            <input type="hidden" name="mode" value="{{ $mode }}">
                                ...
                                <tr>
                                    ...
                                    @if($mode == 'price')
                                        <td>
                                            ...
                                            <input type="number" name="supply_price[{{ $goods->goods_seq }}]" value="{{ $goods->supply_price }}" class="form-control form-control-sm mb-1" placeholder="공급가">
                                            <input type="number" name="price[{{ $goods->goods_seq }}]" value="{{ $goods->price }}" class="form-control form-control-sm" placeholder="판매가">
                                        </td>
                                        <td>
